...
{
    class Rl8TileCreator : TileCreator.Abstract.TileCreator, INormalizable
    {
        ...
        protected override float GetMaxValue(LocatorFile loc, int strDataLen, int strHeadLen, int frameHeight)
        {
        ...
        protected override byte[] GetTileLine(Stream s, int strHeaderLength, int signalDataLength, int tileHeight, float normalizationFactor, TileOutputType outputType)
        {
