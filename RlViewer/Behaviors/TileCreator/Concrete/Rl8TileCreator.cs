...
namespace RlViewer.Behaviors.TileCreator.Concrete
{
    class Rl8TileCreator : TileCreator.Abstract.FloatSampleTileCreator
    {
        ...
        {
            return GetTilesFromFile(_rli, new RlViewer.Headers.Concrete.Rl4.Rl4StrHeaderStruct(), OutputType);
        }
        ...
        {
            return GetTilesFromFileAsync(_rli, new RlViewer.Headers.Concrete.Rl4.Rl4StrHeaderStruct(), OutputType);
        }
