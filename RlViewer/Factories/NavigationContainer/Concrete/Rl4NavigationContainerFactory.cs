...
namespace RlViewer.Factories.NavigationContainer.Concrete
{
    public class Rl4NavigationContainerFactory : Abstract.NavigationContainerFactory
    {
        public override Navigation.NavigationContainer Create(RlViewer.Files.FileProperties properties, Headers.Abstract.LocatorFileHeader header)
        {
            ...
            return new Rl4NavigationContainer(properties.FilePath, rl4header.HeaderStruct.synthParams.D0, rl4header.HeaderStruct.rlParams.flipType, rl4header.HeaderStruct.rlParams.width,
                rl4header.HeaderStruct.rlParams.dx, rl4header.HeaderStruct.synthParams.board, rl4header.FileHeaderLength, rl4header.HeaderStruct.rlParams.width * rl4header.BytesPerSample,
