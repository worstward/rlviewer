...
namespace RlViewer.Factories.NavigationContainer.Concrete
{
    public class Rl8NavigationContainerFactory : Abstract.NavigationContainerFactory
    {
        public override Navigation.NavigationContainer Create(RlViewer.Files.FileProperties properties, Headers.Abstract.LocatorFileHeader header)
        {
            ...
            return new Rl8NavigationContainer(properties.FilePath, rl8header.HeaderStruct.synthParams.D0, rl8header.HeaderStruct.rlParams.flipType, rl8header.HeaderStruct.rlParams.width,
                rl8header.HeaderStruct.rlParams.dx, rl8header.HeaderStruct.synthParams.board, rl8header.FileHeaderLength, rl8header.HeaderStruct.rlParams.width * rl8header.BytesPerSample,
