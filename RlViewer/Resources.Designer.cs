...
namespace RlViewer {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на Обработанные файлы|*.brl4;*.raw.
        /// </summary>
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на Файлы РЛИ МРК2 с плавающей точкой(*.rl4)|*.rl4|Файлы РЛИ МРК2 с комплексными отсчетами(*.rl8)|*.rl8|Файлы МРК411 без заголовка (*.raw)|*.raw|Файлы РЛИ Банк-РЛ (*.brl4)|*.brl4|Файлы изображений (*.bmp)|*.bmp.
        /// </summary>
