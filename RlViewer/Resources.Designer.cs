...
namespace RlViewer {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на Файлы РЛИ МРК2 с плавающей точкой(*.rl4)|*.rl4|Файлы РЛИ МРК2 с комплексными отсчетами(*.rl8)|*.rl8|Файлы МРК411 без заголовка (*.raw)|*.raw|Файлы изображений (*.bmp)|*.bmp.
        /// </summary>
